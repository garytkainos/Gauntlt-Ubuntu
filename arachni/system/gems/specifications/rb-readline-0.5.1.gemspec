...
Gem::Specification.new do |s|
  ...
  s.authors = ["Park Heesob".freeze, "Daniel Berger".freeze, "Luis Lavena".freeze]
  s.date = "2014-01-08"
  ...
  s.email = ["phasis@gmail.com".freeze, "djberg96@gmail.com".freeze, "luislavena@gmail.com".freeze]
  s.extra_rdoc_files = ["README.rdoc".freeze, "LICENSE".freeze, "CHANGES".freeze]
  s.files = ["CHANGES".freeze, "LICENSE".freeze, "README.rdoc".freeze]
  s.homepage = "http://github.com/luislavena/rb-readline".freeze
  s.licenses = ["BSD".freeze]
  s.rdoc_options = ["--main".freeze, "README.rdoc".freeze, "--title".freeze, "Rb-Readline - Documentation".freeze]
